      ...
      <div className="relative isolate px-6  lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-38 lg:py-56">
          {/* <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full  text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              an emotional reaction in customers. Customers uses these graphics
